...
const SEOHeroSection = () => {
  return (
    <section className="mobile-hero-spacing pb-12 md:pb-16 bg-gradient-to-r from-blue-50 to-indigo-50 relative overflow-hidden" aria-label="E-commerce SEO Services">
