...
const JobApplicationForm: React.FC<JobApplicationFormProps> = ({ 
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const subject = encodeURIComponent(`${jobTitle} Application from ${data.fullName}`);
      ...
      setFormError("There was a problem processing your application. Please email your resume directly to info@stellmedia.com.");
    } finally {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete this form to apply. You will be redirected to your email client to send your application.
          </DialogDescription>
        </DialogHeader>
