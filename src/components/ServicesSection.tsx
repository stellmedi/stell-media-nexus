...
const services = [{
  ...
  features: ["AI-driven search optimization", "Machine learning for navigation", "Intelligent product filtering", "Automated data enrichment"],
  ...
  features: ["Automated data cleansing", "Machine learning tagging", "AI-powered categorization", "Intelligent taxonomy development"],
  ...
  features: ["AI search algorithm optimization", "Seamless platform migration", "API development & integration", "Performance optimization"],
  ...
  features: ["Omnichannel integration", "In-store digital experiences", "Unified inventory management", "Cross-channel analytics"],
  ...
  features: ["AI-powered campaign optimization", "Automated performance tracking", "Product feed automation", "Conversion optimization"],
  ...
  features: ["Workflow automation", "Inventory management automation", "Customer service AI tools", "Analytics and reporting automation"],
