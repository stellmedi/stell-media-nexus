      ...
      <main>
        ...
        <section className="pt-32 pb-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm text-indigo-700 rounded-full text-sm font-semibold mb-6 shadow-sm border-2 border-indigo-200">
                <span className="w-2 h-2 bg-indigo-500 rounded-full mr-2"></span>
                Expert Answers
              </div>
              <h1 className="text-4xl md:text-6xl font-bold mb-8 bg-gradient-to-r from-gray-900 via-blue-800 to-indigo-900 bg-clip-text text-transparent text-center">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 mb-12 border-2 border-blue-200 shadow-xl">
              <FAQSection 
                items={generalFAQs} 
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 mb-12 border-2 border-green-200 shadow-xl">
              <FAQSection 
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 mb-12 border-2 border-purple-200 shadow-xl">
              <FAQSection 
                items={eCommerceFAQs} 
        ...
        <section className="py-20 bg-gradient-to-r from-blue-700 via-indigo-600 to-purple-600 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-12 border-2 border-white/20 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a 
                  ...
                  className="inline-flex items-center px-10 py-4 bg-white text-indigo-600 hover:bg-gray-100 font-semibold rounded-lg text-lg shadow-lg transition-all duration-300 border-2 border-white"
                >
