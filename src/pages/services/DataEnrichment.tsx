...
const DataEnrichment = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Hero Section */}
        <section className="mobile-hero-spacing pb-16 bg-gradient-to-r from-blue-50 to-indigo-50" style={{ paddingTop: 'max(7rem, calc(64px + env(safe-area-inset-top, 0px)))' }}>
