...
const services = [{
  ...
  features: ["Strategic search relevance optimization", "Smart behavioral insights integration", "Intelligent navigation restructuring", "Product data cleanup and enrichment", "Advanced faceted filtering implementation", "Real-time search analytics and insights", "Relevance algorithm enhancements", "Personalized product recommendation engines"],
  ...
  features: ["Automated data cleansing and standardization", "Smart attribute mapping solutions", "Product tagging automation", "Intelligent taxonomy development", "Real-time data quality assessment", "Automated master data management", "Strategic product categorization", "Streamlined legacy data migration"],
  ...
  features: ["Search platform migration expertise", "Algorithm optimization services", "Seamless data transition strategies", "Performance optimization strategies", "Headless commerce architecture", "E-commerce platform integration", "Custom search configuration", "Search relevance fine-tuning"],
  ...
  features: ["Comprehensive technical SEO audits", "Automated product page optimization", "Strategic category structure enhancement", "Predictive content gap analysis", "Automated keyword research and mapping", "Mobile optimization strategies", "Strategic URL structure optimization", "Automated schema markup implementation"],
  link: "/services/seo"
}, {
  ...
  features: ["AI-powered Google Shopping optimization", "Automated performance-based campaigns", "Dynamic product feed management", "Conversion tracking automation", "AI-driven bid management strategies", "ML audience targeting optimization", "Automated creative A/B testing", "ROAS optimization through AI"],
  link: "/services/sem"
}, {
  ...
  features: ["Unified inventory management", "Click-and-collect implementation", "In-store digital experience design", "Omnichannel customer journey mapping", "Mobile app development for stores", "Store locator and local inventory API", "Cross-channel analytics integration", "Hybrid loyalty program development"],
  ...
  features: ["Computer vision for product recognition", "NLP for customer service automation", "Predictive inventory management", "Fraud detection algorithms", "Customer behavior prediction models", "Price optimization algorithms", "Visual search implementation", "Voice commerce integration"],
  ...
  features: ["Marketing automation workflows", "Inventory update automation", "Order processing automation", "Customer service chatbots", "Email marketing automation", "Product data syndication", "Reporting and analytics automation", "Cross-platform data synchronization"],
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="space-y-16">
              {services.slice(0, 6).map((service, index) => <div key={index} className="grid md:grid-cols-2 gap-8 items-center py-8">
